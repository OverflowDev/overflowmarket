            ...
            <div className="inline-block px-4 py-2">
                <div className="group overflow-hidden relative max-w-md w-80 h-80 md:w-64 md:h-64 rounded-lg shadow-md bg-white hover:shadow-xl">
                    ...
                    {/* <div className=""> */}
                        <button 
                            onClick={() => add(popular)}
                            className="absolute inset-x-[17%] bottom-[40%] w-4/6   bg-white group-hover:bg-teal-900 group-hover:text-white rounded py-3 uppercase text-center font-bold text-gray-900">
                            Add to Cart
                        </button>
                    {/* </div> */}
                </div>
