                ...
                return (
                    <div key={product.id} className="">
                        <Link to={`/product/${category}/${id}`} >
                            ...
                            <div 
                                className="group overflow-hidden relative max-w-md w-72 h-72 md:w-64 md:h-64 my-4 shadow-sm rounded-lg z-10"
                            >
                                ...
                                <button className='md:group-hover:bottom-14 duration-500 absolute px-5 py-2 bg-white text-black font-semibold rounded hover:bg-teal-400 md:left-1/4 md:-bottom-20 left-1/4 bottom-20'>ADD TO CART</button>
